...
#define X_SERVER_ERROR 10
#define X_INPUT_EXTENSION_ERROR 11
#define X_EVENT_ERROR 12
#define X_INVALID_DEVICE_ERROR 13

typedef int KeyHandlerX11(int);

XIDeviceInfo *find_device_x11(Display *display, const char *device);

int start_monitoring_mods_x11(const char *deviceid, KeyHandlerX11 mod_press_handler,
